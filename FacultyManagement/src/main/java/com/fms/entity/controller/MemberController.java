...
//	@GetMapping("/get-firstName/{fname}")
//	public List<Member> getFname(@PathVariable String fname) {
//
//		return ms.getFname(fname);
//
//	}
//
//	@GetMapping("/get-lastName/{lname}")
//	public List<Member> getLname(@PathVariable String lname) {
//
//		return ms.getLname(lname);
//
//	}
//
//	@GetMapping("/get-phone/{phone}")
//	public Member getPhone(@PathVariable long phone) {
//
//		return ms.getPhone(phone);
//
//	}
